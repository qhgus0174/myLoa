...
import { ILedger, ILedgerOwn } from '@components/Ledger/LedgerType';
                                ...
                                return (
                                    <Article key={ledgerIndex}>
                                        <Header>
                                            ...
                                            <GoldSum>
                                                <TitleAndGold opacity={0.8} title="저번 주" gold={prevWeekGold[0]} />
                                                <TitleAndGold title="이번 주" gold={goodsTotalGold + raidTotalGold} />
                                            </GoldSum>
                                        </Header>
                                        <PersonalHeader
                                            onClick={() =>
